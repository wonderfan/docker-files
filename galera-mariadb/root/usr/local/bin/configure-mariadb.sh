...
#
# Adfinis SyGroup AG
# openshift-galera-mariadb: mysql setup script
#
...
FLUSH PRIVILEGES;
EOSQL
echo "Created user readinessProbe at $(date)" >> /var/lib/mysql/entrypoint.log
echo "SELECT * FROM mysql.user;" | "${mysql[@]}" >> /var/lib/mysql/entrypoint.log
